...
.section .text
glabel getRomheaderFile # 9
/* 00B05C 0040B05C 3C1C0FC0 */  lui         $gp, %hi(_gp_disp)
/* 00B060 0040B060 279C7D04 */  addiu       $gp, $gp, %lo(_gp_disp)
# _gp_disp: 0xFC07D04
/* 00B064 0040B064 0399E021 */  addu        $gp, $gp, $t9
...
/* 00B084 0040B084 8F998018 */  lw          $t9, %got(gloadFindFile)($gp)
/* 00B088 0040B088 8F85802C */  lw          $a1, %got(STR_10004734)($gp)
/* 00B08C 0040B08C 8F86802C */  lw          $a2, %got(STR_10004740)($gp)
/* 00B090 0040B090 2739B780 */  addiu       $t9, $t9, %lo(gloadFindFile)
/* 00B094 0040B094 27A401BC */  addiu       $a0, $sp, 0x1BC
/* 00B098 0040B098 24A54734 */  addiu       $a1, $a1, %lo(STR_10004734)
/* 00B09C 0040B09C 0320F809 */  jalr        $t9
/* 00B0A0 0040B0A0 24C64740 */   addiu      $a2, $a2, %lo(STR_10004740)
...
/* 00B0C0 0040B0C0 8F9980B8 */  lw          $t9, %call16(open)($gp)
...
/* 00B0E8 0040B0E8 8F99806C */  lw          $t9, %call16(sprintf)($gp)
/* 00B0EC 0040B0EC 8F85802C */  lw          $a1, %got(STR_1000474C)($gp)
/* 00B0F0 0040B0F0 8F868030 */  lw          $a2, %got(B_1000BA40)($gp)
/* 00B0F4 0040B0F4 27A40034 */  addiu       $a0, $sp, 0x34
/* 00B0F8 0040B0F8 8FA702C0 */  lw          $a3, 0x2C0($sp)
/* 00B0FC 0040B0FC 24A5474C */  addiu       $a1, $a1, %lo(STR_1000474C)
/* 00B100 0040B100 0320F809 */  jalr        $t9
/* 00B104 0040B104 8CC6BA40 */   lw         $a2, %lo(B_1000BA40)($a2)
/* 00B108 0040B108 8FBC0018 */  lw          $gp, 0x18($sp)
/* 00B10C 0040B10C 8F9980BC */  lw          $t9, %call16(perror)($gp)
...
/* 00B120 0040B120 8F998058 */  lw          $t9, %call16(exit)($gp)
...
.L0040B134:
/* 00B134 0040B134 8F9980C0 */  lw          $t9, %call16(fstat)($gp)
...
/* 00B150 0040B150 8F99806C */  lw          $t9, %call16(sprintf)($gp)
/* 00B154 0040B154 8F85802C */  lw          $a1, %got(STR_10004764)($gp)
/* 00B158 0040B158 8F868030 */  lw          $a2, %got(B_1000BA40)($gp)
/* 00B15C 0040B15C 27A40034 */  addiu       $a0, $sp, 0x34
/* 00B160 0040B160 8FA702C0 */  lw          $a3, 0x2C0($sp)
/* 00B164 0040B164 24A54764 */  addiu       $a1, $a1, %lo(STR_10004764)
/* 00B168 0040B168 0320F809 */  jalr        $t9
/* 00B16C 0040B16C 8CC6BA40 */   lw         $a2, %lo(B_1000BA40)($a2)
/* 00B170 0040B170 8FBC0018 */  lw          $gp, 0x18($sp)
/* 00B174 0040B174 8F9980BC */  lw          $t9, %call16(perror)($gp)
...
/* 00B188 0040B188 8F9980C4 */  lw          $t9, %call16(close)($gp)
...
/* 00B19C 0040B19C 8F998058 */  lw          $t9, %call16(exit)($gp)
...
/* 00B1B4 0040B1B4 8F81873C */  lw          $at, %got(headerWordAlignedByteSize)($gp)
/* 00B1B8 0040B1B8 AC280000 */  sw          $t0, 0x0($at)
/* 00B1BC 0040B1BC 8F998068 */  lw          $t9, %call16(malloc)($gp)
/* 00B1C0 0040B1C0 8F84873C */  lw          $a0, %got(headerWordAlignedByteSize)($gp)
/* 00B1C4 0040B1C4 0320F809 */  jalr        $t9
/* 00B1C8 0040B1C8 8C840000 */   lw         $a0, 0x0($a0)
/* 00B1CC 0040B1CC 8FBC0018 */  lw          $gp, 0x18($sp)
/* 00B1D0 0040B1D0 8F818728 */  lw          $at, %got(headerBuf)($gp)
/* 00B1D4 0040B1D4 AC220000 */  sw          $v0, 0x0($at)
/* 00B1D8 0040B1D8 8F898728 */  lw          $t1, %got(headerBuf)($gp)
/* 00B1DC 0040B1DC 8D290000 */  lw          $t1, 0x0($t1)
/* 00B1E0 0040B1E0 15200016 */  bnez        $t1, .L0040B23C
/* 00B1E4 0040B1E4 00000000 */   nop
/* 00B1E8 0040B1E8 8F998064 */  lw          $t9, %call16(fprintf)($gp)
/* 00B1EC 0040B1EC 8F848044 */  lw          $a0, %got(__iob)($gp)
/* 00B1F0 0040B1F0 8F85802C */  lw          $a1, %got(STR_1000477C)($gp)
/* 00B1F4 0040B1F4 8F868030 */  lw          $a2, %got(B_1000BA40)($gp)
/* 00B1F8 0040B1F8 8F87873C */  lw          $a3, %got(headerWordAlignedByteSize)($gp)
/* 00B1FC 0040B1FC 24840020 */  addiu       $a0, $a0, 0x20
/* 00B200 0040B200 24A5477C */  addiu       $a1, $a1, %lo(STR_1000477C)
/* 00B204 0040B204 8CC6BA40 */  lw          $a2, %lo(B_1000BA40)($a2)
/* 00B208 0040B208 0320F809 */  jalr        $t9
/* 00B20C 0040B20C 8CE70000 */   lw         $a3, 0x0($a3)
/* 00B210 0040B210 8FBC0018 */  lw          $gp, 0x18($sp)
/* 00B214 0040B214 8F9980C4 */  lw          $t9, %call16(close)($gp)
...
/* 00B228 0040B228 8F998058 */  lw          $t9, %call16(exit)($gp)
...
/* 00B244 0040B244 8F8B873C */  lw          $t3, %got(headerWordAlignedByteSize)($gp)
...
.L0040B25C:
/* 00B25C 0040B25C 8F9980C8 */  lw          $t9, %call16(read)($gp)
...
/* 00B288 0040B288 8F998064 */  lw          $t9, %call16(fprintf)($gp)
/* 00B28C 0040B28C 8F848044 */  lw          $a0, %got(__iob)($gp)
/* 00B290 0040B290 8F85802C */  lw          $a1, %got(STR_100047AC)($gp)
/* 00B294 0040B294 8F868030 */  lw          $a2, %got(B_1000BA40)($gp)
/* 00B298 0040B298 8FA702C0 */  lw          $a3, 0x2C0($sp)
/* 00B29C 0040B29C 24840020 */  addiu       $a0, $a0, 0x20
/* 00B2A0 0040B2A0 24A547AC */  addiu       $a1, $a1, %lo(STR_100047AC)
/* 00B2A4 0040B2A4 0320F809 */  jalr        $t9
/* 00B2A8 0040B2A8 8CC6BA40 */   lw         $a2, %lo(B_1000BA40)($a2)
/* 00B2AC 0040B2AC 8FBC0018 */  lw          $gp, 0x18($sp)
/* 00B2B0 0040B2B0 8F9980A4 */  lw          $t9, %call16(free)($gp)
/* 00B2B4 0040B2B4 8F848728 */  lw          $a0, %got(headerBuf)($gp)
/* 00B2B8 0040B2B8 0320F809 */  jalr        $t9
/* 00B2BC 0040B2BC 8C840000 */   lw         $a0, 0x0($a0)
/* 00B2C0 0040B2C0 8FBC0018 */  lw          $gp, 0x18($sp)
/* 00B2C4 0040B2C4 8F9980C4 */  lw          $t9, %call16(close)($gp)
...
/* 00B2D8 0040B2D8 8F998058 */  lw          $t9, %call16(exit)($gp)
...
/* 00B300 0040B300 8F99873C */  lw          $t9, %got(headerWordAlignedByteSize)($gp)
...
/* 00B320 0040B320 8F9980C8 */  lw          $t9, %call16(read)($gp)
...
/* 00B34C 0040B34C 8F998064 */  lw          $t9, %call16(fprintf)($gp)
/* 00B350 0040B350 8F848044 */  lw          $a0, %got(__iob)($gp)
/* 00B354 0040B354 8F85802C */  lw          $a1, %got(STR_100047C8)($gp)
/* 00B358 0040B358 8F868030 */  lw          $a2, %got(B_1000BA40)($gp)
/* 00B35C 0040B35C 8FA702C0 */  lw          $a3, 0x2C0($sp)
/* 00B360 0040B360 24840020 */  addiu       $a0, $a0, 0x20
/* 00B364 0040B364 24A547C8 */  addiu       $a1, $a1, %lo(STR_100047C8)
/* 00B368 0040B368 0320F809 */  jalr        $t9
/* 00B36C 0040B36C 8CC6BA40 */   lw         $a2, %lo(B_1000BA40)($a2)
/* 00B370 0040B370 8FBC0018 */  lw          $gp, 0x18($sp)
/* 00B374 0040B374 8F9980A4 */  lw          $t9, %call16(free)($gp)
/* 00B378 0040B378 8F848728 */  lw          $a0, %got(headerBuf)($gp)
/* 00B37C 0040B37C 0320F809 */  jalr        $t9
/* 00B380 0040B380 8C840000 */   lw         $a0, 0x0($a0)
/* 00B384 0040B384 8FBC0018 */  lw          $gp, 0x18($sp)
/* 00B388 0040B388 8F9980C4 */  lw          $t9, %call16(close)($gp)
...
/* 00B39C 0040B39C 8F998058 */  lw          $t9, %call16(exit)($gp)
...
.L0040B3B0:
/* 00B3B0 0040B3B0 8F998078 */  lw          $t9, %call16(strtol)($gp)
...
/* 00B3EC 0040B3EC 8F8D8728 */  lw          $t5, %got(headerBuf)($gp)
...
.L0040B414:
/* 00B414 0040B414 8F8A8728 */  lw          $t2, %got(headerBuf)($gp)
...
.L0040B434:
/* 00B434 0040B434 8F88873C */  lw          $t0, %got(headerWordAlignedByteSize)($gp)
...
/* 00B460 0040B460 8F81873C */  lw          $at, %got(headerWordAlignedByteSize)($gp)
/* 00B464 0040B464 256AFFFF */  addiu       $t2, $t3, -0x1
/* 00B468 0040B468 000A6043 */  sra         $t4, $t2, 1
/* 00B46C 0040B46C AC2C0000 */  sw          $t4, 0x0($at)
/* 00B470 0040B470 8F89873C */  lw          $t1, %got(headerWordAlignedByteSize)($gp)
...
/* 00B484 0040B484 8F8F873C */  lw          $t7, %got(headerWordAlignedByteSize)($gp)
/* 00B488 0040B488 8F81873C */  lw          $at, %got(headerWordAlignedByteSize)($gp)
/* 00B48C 0040B48C 8DEF0000 */  lw          $t7, 0x0($t7)
/* 00B490 0040B490 25F80004 */  addiu       $t8, $t7, 0x4
/* 00B494 0040B494 AC380000 */  sw          $t8, 0x0($at)
/* 00B498 0040B498 8F99873C */  lw          $t9, %got(headerWordAlignedByteSize)($gp)
/* 00B49C 0040B49C 2401FFFC */  addiu       $at, $zero, -0x4
/* 00B4A0 0040B4A0 8F390000 */  lw          $t9, 0x0($t9)
/* 00B4A4 0040B4A4 03217024 */  and         $t6, $t9, $at
/* 00B4A8 0040B4A8 8F81873C */  lw          $at, %got(headerWordAlignedByteSize)($gp)
/* 00B4AC 0040B4AC AC2E0000 */  sw          $t6, 0x0($at)
.L0040B4B0:
/* 00B4B0 0040B4B0 8F9980C4 */  lw          $t9, %call16(close)($gp)
...
.L0040B4C8:
/* 00B4C8 0040B4C8 8F818728 */  lw          $at, %got(headerBuf)($gp)
