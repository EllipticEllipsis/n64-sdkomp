...
.section .text
glabel gloadFindFile # 11
/* 00B780 0040B780 3C1C0FC0 */  lui         $gp, %hi(_gp_disp)
/* 00B784 0040B784 279C75E0 */  addiu       $gp, $gp, %lo(_gp_disp)
# _gp_disp: 0xFC075E0
/* 00B788 0040B788 0399E021 */  addu        $gp, $gp, $t9
...
.L0040B7E0:
/* 00B7E0 0040B7E0 8F8F802C */  lw          $t7, %got(STR_10004870)($gp)
/* 00B7E4 0040B7E4 25EF4870 */  addiu       $t7, $t7, %lo(STR_10004870)
/* 00B7E8 0040B7E8 AFAF0034 */  sw          $t7, 0x34($sp)
/* 00B7EC 0040B7EC 10000009 */  b           .L0040B814
/* 00B7F0 0040B7F0 00000000 */   nop
.L0040B7F4:
/* 00B7F4 0040B7F4 8F98802C */  lw          $t8, %got(STR_10004878)($gp)
/* 00B7F8 0040B7F8 27184878 */  addiu       $t8, $t8, %lo(STR_10004878)
...
/* 00B820 0040B820 8F998098 */  lw          $t9, %call16(getenv)($gp)
...
.L0040B84C:
/* 00B84C 0040B84C 8F99809C */  lw          $t9, %call16(strcat)($gp)
...
/* 00B870 0040B870 8F99809C */  lw          $t9, %call16(strcat)($gp)
...
/* 00B888 0040B888 8F99809C */  lw          $t9, %call16(strcat)($gp)
/* 00B88C 0040B88C 8F85802C */  lw          $a1, %got(STR_10004884)($gp)
/* 00B890 0040B890 8FA40038 */  lw          $a0, 0x38($sp)
/* 00B894 0040B894 0320F809 */  jalr        $t9
/* 00B898 0040B898 24A54884 */   addiu      $a1, $a1, %lo(STR_10004884)
/* 00B89C 0040B89C 8FBC0018 */  lw          $gp, 0x18($sp)
.L0040B8A0:
/* 00B8A0 0040B8A0 8F99809C */  lw          $t9, %call16(strcat)($gp)
...
/* 00B8B8 0040B8B8 8F9980CC */  lw          $t9, %call16(access)($gp)
...
/* 00B8F0 0040B8F0 8F998064 */  lw          $t9, %call16(fprintf)($gp)
/* 00B8F4 0040B8F4 8F848044 */  lw          $a0, %got(__iob)($gp)
/* 00B8F8 0040B8F8 8F85802C */  lw          $a1, %got(STR_10004888)($gp)
/* 00B8FC 0040B8FC 8FA60038 */  lw          $a2, 0x38($sp)
/* 00B900 0040B900 24840020 */  addiu       $a0, $a0, 0x20
/* 00B904 0040B904 0320F809 */  jalr        $t9
/* 00B908 0040B908 24A54888 */   addiu      $a1, $a1, %lo(STR_10004888)
