...
.L004096EC:
/* 0096EC 004096EC 3C1C0FC1 */  lui         $gp, %hi(_gp_disp)
/* 0096F0 004096F0 279C9674 */  addiu       $gp, $gp, %lo(_gp_disp)
# _gp_disp: 0xFC09674
/* 0096F4 004096F4 039FE021 */  addu        $gp, $gp, $ra
/* 0096F8 004096F8 0100F825 */  move        $ra, $t0
/* 0096FC 004096FC 3C070000 */  lui         $a3, %got_hi(_environ)
/* 009700 00409700 00FC3821 */  addu        $a3, $a3, $gp
/* 009704 00409704 8CE78038 */  lw          $a3, %got_lo(_environ)($a3)
...
/* 00975C 0040975C 8F398654 */  lw          $t9, %call_lo(__istart)($t9)
/* 009760 00409760 003C0821 */  addu        $at, $at, $gp
/* 009764 00409764 8C2187C0 */  lw          $at, %got_lo(__Argv)($at)
...
/* 009788 00409788 8F39805C */  lw          $t9, %call_lo(__readenv_sigfpe)($t9)
...
/* 0097AC 004097AC 8F398188 */  lw          $t9, %call_lo(main)($t9)
/* 0097B0 004097B0 009C2021 */  addu        $a0, $a0, $gp
/* 0097B4 004097B4 00BC2821 */  addu        $a1, $a1, $gp
/* 0097B8 004097B8 00DC3021 */  addu        $a2, $a2, $gp
/* 0097BC 004097BC 8C8487C4 */  lw          $a0, %got_lo(__Argc)($a0)
/* 0097C0 004097C0 8CA587C0 */  lw          $a1, %got_lo(__Argv)($a1)
/* 0097C4 004097C4 8CC68038 */  lw          $a2, %got_lo(_environ)($a2)
...
/* 0097E8 004097E8 8F398058 */  lw          $t9, %call_lo(exit)($t9)
