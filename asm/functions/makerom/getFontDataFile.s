...
.section .text
glabel getFontDataFile # 10
/* 00B4E8 0040B4E8 3C1C0FC0 */  lui         $gp, %hi(_gp_disp)
/* 00B4EC 0040B4EC 279C7878 */  addiu       $gp, $gp, %lo(_gp_disp)
# _gp_disp: 0xFC07878
/* 00B4F0 0040B4F0 0399E021 */  addu        $gp, $gp, $t9
...
/* 00B504 0040B504 8F998018 */  lw          $t9, %got(gloadFindFile)($gp)
/* 00B508 0040B508 8F85802C */  lw          $a1, %got(STR_100047E4)($gp)
/* 00B50C 0040B50C 8F86802C */  lw          $a2, %got(STR_100047F0)($gp)
/* 00B510 0040B510 2739B780 */  addiu       $t9, $t9, %lo(gloadFindFile)
/* 00B514 0040B514 27A401AC */  addiu       $a0, $sp, 0x1AC
/* 00B518 0040B518 24A547E4 */  addiu       $a1, $a1, %lo(STR_100047E4)
/* 00B51C 0040B51C 0320F809 */  jalr        $t9
/* 00B520 0040B520 24C647F0 */   addiu      $a2, $a2, %lo(STR_100047F0)
...
/* 00B540 0040B540 8F9980B8 */  lw          $t9, %call16(open)($gp)
...
/* 00B568 0040B568 8F99806C */  lw          $t9, %call16(sprintf)($gp)
/* 00B56C 0040B56C 8F85802C */  lw          $a1, %got(STR_100047F8)($gp)
/* 00B570 0040B570 8F868030 */  lw          $a2, %got(B_1000BA40)($gp)
/* 00B574 0040B574 27A40024 */  addiu       $a0, $sp, 0x24
/* 00B578 0040B578 8FA702B0 */  lw          $a3, 0x2B0($sp)
/* 00B57C 0040B57C 24A547F8 */  addiu       $a1, $a1, %lo(STR_100047F8)
/* 00B580 0040B580 0320F809 */  jalr        $t9
/* 00B584 0040B584 8CC6BA40 */   lw         $a2, %lo(B_1000BA40)($a2)
/* 00B588 0040B588 8FBC0018 */  lw          $gp, 0x18($sp)
/* 00B58C 0040B58C 8F9980BC */  lw          $t9, %call16(perror)($gp)
...
/* 00B5A0 0040B5A0 8F998058 */  lw          $t9, %call16(exit)($gp)
...
.L0040B5B4:
/* 00B5B4 0040B5B4 8F9980C0 */  lw          $t9, %call16(fstat)($gp)
...
/* 00B5D0 0040B5D0 8F99806C */  lw          $t9, %call16(sprintf)($gp)
/* 00B5D4 0040B5D4 8F85802C */  lw          $a1, %got(STR_10004810)($gp)
/* 00B5D8 0040B5D8 8F868030 */  lw          $a2, %got(B_1000BA40)($gp)
/* 00B5DC 0040B5DC 27A40024 */  addiu       $a0, $sp, 0x24
/* 00B5E0 0040B5E0 8FA702B0 */  lw          $a3, 0x2B0($sp)
/* 00B5E4 0040B5E4 24A54810 */  addiu       $a1, $a1, %lo(STR_10004810)
/* 00B5E8 0040B5E8 0320F809 */  jalr        $t9
/* 00B5EC 0040B5EC 8CC6BA40 */   lw         $a2, %lo(B_1000BA40)($a2)
/* 00B5F0 0040B5F0 8FBC0018 */  lw          $gp, 0x18($sp)
/* 00B5F4 0040B5F4 8F9980BC */  lw          $t9, %call16(perror)($gp)
...
/* 00B608 0040B608 8F9980C4 */  lw          $t9, %call16(close)($gp)
...
/* 00B61C 0040B61C 8F998058 */  lw          $t9, %call16(exit)($gp)
...
.L0040B630:
/* 00B630 0040B630 8F998068 */  lw          $t9, %call16(malloc)($gp)
...
/* 00B644 0040B644 8F818730 */  lw          $at, %got(fontBuf)($gp)
/* 00B648 0040B648 AC220000 */  sw          $v0, 0x0($at)
/* 00B64C 0040B64C 8F998730 */  lw          $t9, %got(fontBuf)($gp)
/* 00B650 0040B650 8F390000 */  lw          $t9, 0x0($t9)
/* 00B654 0040B654 17200015 */  bnez        $t9, .L0040B6AC
/* 00B658 0040B658 00000000 */   nop
/* 00B65C 0040B65C 8F998064 */  lw          $t9, %call16(fprintf)($gp)
/* 00B660 0040B660 8F848044 */  lw          $a0, %got(__iob)($gp)
/* 00B664 0040B664 8F85802C */  lw          $a1, %got(STR_10004828)($gp)
/* 00B668 0040B668 8F868030 */  lw          $a2, %got(B_1000BA40)($gp)
/* 00B66C 0040B66C 8FA70154 */  lw          $a3, 0x154($sp)
/* 00B670 0040B670 24840020 */  addiu       $a0, $a0, 0x20
/* 00B674 0040B674 24A54828 */  addiu       $a1, $a1, %lo(STR_10004828)
/* 00B678 0040B678 0320F809 */  jalr        $t9
/* 00B67C 0040B67C 8CC6BA40 */   lw         $a2, %lo(B_1000BA40)($a2)
/* 00B680 0040B680 8FBC0018 */  lw          $gp, 0x18($sp)
/* 00B684 0040B684 8F9980C4 */  lw          $t9, %call16(close)($gp)
...
/* 00B698 0040B698 8F998058 */  lw          $t9, %call16(exit)($gp)
...
/* 00B6B0 0040B6B0 8F818740 */  lw          $at, %got(fontdataWordAlignedByteSize)($gp)
/* 00B6B4 0040B6B4 AC280000 */  sw          $t0, 0x0($at)
/* 00B6B8 0040B6B8 8F9980C8 */  lw          $t9, %call16(read)($gp)
/* 00B6BC 0040B6BC 8F858730 */  lw          $a1, %got(fontBuf)($gp)
/* 00B6C0 0040B6C0 8F868740 */  lw          $a2, %got(fontdataWordAlignedByteSize)($gp)
...
/* 00B6D8 0040B6D8 8F898740 */  lw          $t1, %got(fontdataWordAlignedByteSize)($gp)
/* 00B6DC 0040B6DC 8D290000 */  lw          $t1, 0x0($t1)
/* 00B6E0 0040B6E0 10490019 */  beq         $v0, $t1, .L0040B748
/* 00B6E4 0040B6E4 00000000 */   nop
/* 00B6E8 0040B6E8 8F99806C */  lw          $t9, %call16(sprintf)($gp)
/* 00B6EC 0040B6EC 8F85802C */  lw          $a1, %got(STR_10004858)($gp)
/* 00B6F0 0040B6F0 8F868030 */  lw          $a2, %got(B_1000BA40)($gp)
/* 00B6F4 0040B6F4 27A40024 */  addiu       $a0, $sp, 0x24
/* 00B6F8 0040B6F8 8FA702B0 */  lw          $a3, 0x2B0($sp)
/* 00B6FC 0040B6FC 24A54858 */  addiu       $a1, $a1, %lo(STR_10004858)
/* 00B700 0040B700 0320F809 */  jalr        $t9
/* 00B704 0040B704 8CC6BA40 */   lw         $a2, %lo(B_1000BA40)($a2)
/* 00B708 0040B708 8FBC0018 */  lw          $gp, 0x18($sp)
/* 00B70C 0040B70C 8F9980BC */  lw          $t9, %call16(perror)($gp)
...
/* 00B720 0040B720 8F9980C4 */  lw          $t9, %call16(close)($gp)
...
/* 00B734 0040B734 8F998058 */  lw          $t9, %call16(exit)($gp)
...
.L0040B748:
/* 00B748 0040B748 8F9980C4 */  lw          $t9, %call16(close)($gp)
...
.L0040B760:
/* 00B760 0040B760 8F818730 */  lw          $at, %got(fontBuf)($gp)
