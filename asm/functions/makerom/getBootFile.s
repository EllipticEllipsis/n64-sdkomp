...
.section .text
glabel getBootFile # 7
/* 00AC0C 0040AC0C 3C1C0FC1 */  lui         $gp, %hi(_gp_disp)
/* 00AC10 0040AC10 279C8154 */  addiu       $gp, $gp, %lo(_gp_disp)
# _gp_disp: 0xFC08154
/* 00AC14 0040AC14 0399E021 */  addu        $gp, $gp, $t9
...
/* 00AC34 0040AC34 8F998018 */  lw          $t9, %got(gloadFindFile)($gp)
/* 00AC38 0040AC38 8F85802C */  lw          $a1, %got(STR_10004648)($gp)
/* 00AC3C 0040AC3C 8F86802C */  lw          $a2, %got(STR_10004654)($gp)
/* 00AC40 0040AC40 2739B780 */  addiu       $t9, $t9, %lo(gloadFindFile)
/* 00AC44 0040AC44 27A401AC */  addiu       $a0, $sp, 0x1AC
/* 00AC48 0040AC48 24A54648 */  addiu       $a1, $a1, %lo(STR_10004648)
/* 00AC4C 0040AC4C 0320F809 */  jalr        $t9
/* 00AC50 0040AC50 24C64654 */   addiu      $a2, $a2, %lo(STR_10004654)
...
/* 00AC70 0040AC70 8F9980B8 */  lw          $t9, %call16(open)($gp)
...
/* 00AC98 0040AC98 8F99806C */  lw          $t9, %call16(sprintf)($gp)
/* 00AC9C 0040AC9C 8F85802C */  lw          $a1, %got(STR_1000465C)($gp)
/* 00ACA0 0040ACA0 8F868030 */  lw          $a2, %got(B_1000BA40)($gp)
/* 00ACA4 0040ACA4 27A40024 */  addiu       $a0, $sp, 0x24
/* 00ACA8 0040ACA8 8FA702B0 */  lw          $a3, 0x2B0($sp)
/* 00ACAC 0040ACAC 24A5465C */  addiu       $a1, $a1, %lo(STR_1000465C)
/* 00ACB0 0040ACB0 0320F809 */  jalr        $t9
/* 00ACB4 0040ACB4 8CC6BA40 */   lw         $a2, %lo(B_1000BA40)($a2)
/* 00ACB8 0040ACB8 8FBC0018 */  lw          $gp, 0x18($sp)
/* 00ACBC 0040ACBC 8F9980BC */  lw          $t9, %call16(perror)($gp)
...
/* 00ACD0 0040ACD0 8F998058 */  lw          $t9, %call16(exit)($gp)
...
.L0040ACE4:
/* 00ACE4 0040ACE4 8F9980C0 */  lw          $t9, %call16(fstat)($gp)
...
/* 00AD00 0040AD00 8F99806C */  lw          $t9, %call16(sprintf)($gp)
/* 00AD04 0040AD04 8F85802C */  lw          $a1, %got(STR_10004674)($gp)
/* 00AD08 0040AD08 8F868030 */  lw          $a2, %got(B_1000BA40)($gp)
/* 00AD0C 0040AD0C 27A40024 */  addiu       $a0, $sp, 0x24
/* 00AD10 0040AD10 8FA702B0 */  lw          $a3, 0x2B0($sp)
/* 00AD14 0040AD14 24A54674 */  addiu       $a1, $a1, %lo(STR_10004674)
/* 00AD18 0040AD18 0320F809 */  jalr        $t9
/* 00AD1C 0040AD1C 8CC6BA40 */   lw         $a2, %lo(B_1000BA40)($a2)
/* 00AD20 0040AD20 8FBC0018 */  lw          $gp, 0x18($sp)
/* 00AD24 0040AD24 8F9980BC */  lw          $t9, %call16(perror)($gp)
...
/* 00AD38 0040AD38 8F9980C4 */  lw          $t9, %call16(close)($gp)
...
/* 00AD4C 0040AD4C 8F998058 */  lw          $t9, %call16(exit)($gp)
...
.L0040AD60:
/* 00AD60 0040AD60 8F998068 */  lw          $t9, %call16(malloc)($gp)
...
/* 00AD74 0040AD74 8F818724 */  lw          $at, %got(bootBuf)($gp)
/* 00AD78 0040AD78 AC220000 */  sw          $v0, 0x0($at)
/* 00AD7C 0040AD7C 8F888724 */  lw          $t0, %got(bootBuf)($gp)
/* 00AD80 0040AD80 8D080000 */  lw          $t0, 0x0($t0)
/* 00AD84 0040AD84 15000015 */  bnez        $t0, .L0040ADDC
/* 00AD88 0040AD88 00000000 */   nop
/* 00AD8C 0040AD8C 8F998064 */  lw          $t9, %call16(fprintf)($gp)
/* 00AD90 0040AD90 8F848044 */  lw          $a0, %got(__iob)($gp)
/* 00AD94 0040AD94 8F85802C */  lw          $a1, %got(STR_1000468C)($gp)
/* 00AD98 0040AD98 8F868030 */  lw          $a2, %got(B_1000BA40)($gp)
/* 00AD9C 0040AD9C 8FA70154 */  lw          $a3, 0x154($sp)
/* 00ADA0 0040ADA0 24840020 */  addiu       $a0, $a0, 0x20
/* 00ADA4 0040ADA4 24A5468C */  addiu       $a1, $a1, %lo(STR_1000468C)
/* 00ADA8 0040ADA8 0320F809 */  jalr        $t9
/* 00ADAC 0040ADAC 8CC6BA40 */   lw         $a2, %lo(B_1000BA40)($a2)
/* 00ADB0 0040ADB0 8FBC0018 */  lw          $gp, 0x18($sp)
/* 00ADB4 0040ADB4 8F9980C4 */  lw          $t9, %call16(close)($gp)
...
/* 00ADC8 0040ADC8 8F998058 */  lw          $t9, %call16(exit)($gp)
...
.L0040ADDC:
/* 00ADDC 0040ADDC 8F9980C4 */  lw          $t9, %call16(close)($gp)
...
/* 00ADF0 0040ADF0 8F9981B4 */  lw          $t9, %call16(readCoff)($gp)
/* 00ADF4 0040ADF4 8F858724 */  lw          $a1, %got(bootBuf)($gp)
...
/* 00AE08 0040AE08 8F818734 */  lw          $at, %got(bootWordAlignedByteSize)($gp)
/* 00AE0C 0040AE0C 10000003 */  b           .L0040AE1C
/* 00AE10 0040AE10 AC220000 */   sw         $v0, 0x0($at)
.L0040AE14:
/* 00AE14 0040AE14 8F818724 */  lw          $at, %got(bootBuf)($gp)
