...
.section .text
glabel getPif2BootFile # 8
/* 00AE34 0040AE34 3C1C0FC0 */  lui         $gp, %hi(_gp_disp)
/* 00AE38 0040AE38 279C7F2C */  addiu       $gp, $gp, %lo(_gp_disp)
# _gp_disp: 0xFC07F2C
/* 00AE3C 0040AE3C 0399E021 */  addu        $gp, $gp, $t9
...
/* 00AE5C 0040AE5C 8F998018 */  lw          $t9, %got(gloadFindFile)($gp)
/* 00AE60 0040AE60 8F85802C */  lw          $a1, %got(STR_100046BC)($gp)
/* 00AE64 0040AE64 8F86802C */  lw          $a2, %got(STR_100046C8)($gp)
/* 00AE68 0040AE68 2739B780 */  addiu       $t9, $t9, %lo(gloadFindFile)
/* 00AE6C 0040AE6C 27A401AC */  addiu       $a0, $sp, 0x1AC
/* 00AE70 0040AE70 24A546BC */  addiu       $a1, $a1, %lo(STR_100046BC)
/* 00AE74 0040AE74 0320F809 */  jalr        $t9
/* 00AE78 0040AE78 24C646C8 */   addiu      $a2, $a2, %lo(STR_100046C8)
...
/* 00AE98 0040AE98 8F9980B8 */  lw          $t9, %call16(open)($gp)
...
/* 00AEC0 0040AEC0 8F99806C */  lw          $t9, %call16(sprintf)($gp)
/* 00AEC4 0040AEC4 8F85802C */  lw          $a1, %got(STR_100046D4)($gp)
/* 00AEC8 0040AEC8 8F868030 */  lw          $a2, %got(B_1000BA40)($gp)
/* 00AECC 0040AECC 27A40024 */  addiu       $a0, $sp, 0x24
/* 00AED0 0040AED0 8FA702B0 */  lw          $a3, 0x2B0($sp)
/* 00AED4 0040AED4 24A546D4 */  addiu       $a1, $a1, %lo(STR_100046D4)
/* 00AED8 0040AED8 0320F809 */  jalr        $t9
/* 00AEDC 0040AEDC 8CC6BA40 */   lw         $a2, %lo(B_1000BA40)($a2)
/* 00AEE0 0040AEE0 8FBC0018 */  lw          $gp, 0x18($sp)
/* 00AEE4 0040AEE4 8F9980BC */  lw          $t9, %call16(perror)($gp)
...
/* 00AEF8 0040AEF8 8F998058 */  lw          $t9, %call16(exit)($gp)
...
.L0040AF0C:
/* 00AF0C 0040AF0C 8F9980C0 */  lw          $t9, %call16(fstat)($gp)
...
/* 00AF28 0040AF28 8F99806C */  lw          $t9, %call16(sprintf)($gp)
/* 00AF2C 0040AF2C 8F85802C */  lw          $a1, %got(STR_100046EC)($gp)
/* 00AF30 0040AF30 8F868030 */  lw          $a2, %got(B_1000BA40)($gp)
/* 00AF34 0040AF34 27A40024 */  addiu       $a0, $sp, 0x24
/* 00AF38 0040AF38 8FA702B0 */  lw          $a3, 0x2B0($sp)
/* 00AF3C 0040AF3C 24A546EC */  addiu       $a1, $a1, %lo(STR_100046EC)
/* 00AF40 0040AF40 0320F809 */  jalr        $t9
/* 00AF44 0040AF44 8CC6BA40 */   lw         $a2, %lo(B_1000BA40)($a2)
/* 00AF48 0040AF48 8FBC0018 */  lw          $gp, 0x18($sp)
/* 00AF4C 0040AF4C 8F9980BC */  lw          $t9, %call16(perror)($gp)
...
/* 00AF60 0040AF60 8F9980C4 */  lw          $t9, %call16(close)($gp)
...
/* 00AF74 0040AF74 8F998058 */  lw          $t9, %call16(exit)($gp)
...
.L0040AF88:
/* 00AF88 0040AF88 8F998068 */  lw          $t9, %call16(malloc)($gp)
...
/* 00AF9C 0040AF9C 8F81872C */  lw          $at, %got(pif2bootBuf)($gp)
/* 00AFA0 0040AFA0 AC220000 */  sw          $v0, 0x0($at)
/* 00AFA4 0040AFA4 8F88872C */  lw          $t0, %got(pif2bootBuf)($gp)
/* 00AFA8 0040AFA8 8D080000 */  lw          $t0, 0x0($t0)
/* 00AFAC 0040AFAC 15000015 */  bnez        $t0, .L0040B004
/* 00AFB0 0040AFB0 00000000 */   nop
/* 00AFB4 0040AFB4 8F998064 */  lw          $t9, %call16(fprintf)($gp)
/* 00AFB8 0040AFB8 8F848044 */  lw          $a0, %got(__iob)($gp)
/* 00AFBC 0040AFBC 8F85802C */  lw          $a1, %got(STR_10004704)($gp)
/* 00AFC0 0040AFC0 8F868030 */  lw          $a2, %got(B_1000BA40)($gp)
/* 00AFC4 0040AFC4 8FA70154 */  lw          $a3, 0x154($sp)
/* 00AFC8 0040AFC8 24840020 */  addiu       $a0, $a0, 0x20
/* 00AFCC 0040AFCC 24A54704 */  addiu       $a1, $a1, %lo(STR_10004704)
/* 00AFD0 0040AFD0 0320F809 */  jalr        $t9
/* 00AFD4 0040AFD4 8CC6BA40 */   lw         $a2, %lo(B_1000BA40)($a2)
/* 00AFD8 0040AFD8 8FBC0018 */  lw          $gp, 0x18($sp)
/* 00AFDC 0040AFDC 8F9980C4 */  lw          $t9, %call16(close)($gp)
...
/* 00AFF0 0040AFF0 8F998058 */  lw          $t9, %call16(exit)($gp)
...
.L0040B004:
/* 00B004 0040B004 8F9980C4 */  lw          $t9, %call16(close)($gp)
...
/* 00B018 0040B018 8F9981B4 */  lw          $t9, %call16(readCoff)($gp)
/* 00B01C 0040B01C 8F85872C */  lw          $a1, %got(pif2bootBuf)($gp)
...
/* 00B030 0040B030 8F818738 */  lw          $at, %got(pif2bootWordAlignedByteSize)($gp)
/* 00B034 0040B034 10000003 */  b           .L0040B044
/* 00B038 0040B038 AC220000 */   sw         $v0, 0x0($at)
.L0040B03C:
/* 00B03C 0040B03C 8F81872C */  lw          $at, %got(pif2bootBuf)($gp)
